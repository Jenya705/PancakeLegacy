 ...
 * @since Jul 30, 2015
 */
public final class BukkitArmorEquipEvent extends PlayerEvent implements Cancellable{
	 ...
	 */
	public BukkitArmorEquipEvent(final Player player, final EquipMethod equipType, final ArmorType type, final ItemStack oldArmorPiece, final ItemStack newArmorPiece){
		super(player);
